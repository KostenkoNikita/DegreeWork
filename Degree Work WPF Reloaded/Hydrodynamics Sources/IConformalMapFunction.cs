...
{
    /// <summary>
    /// Интерфейс, содержаший общие методы и индексатор для функции конформного отображения.
    /// Использование интерфейсной ссылки позволяет использовать полиморфизм в коде, определив
    /// в классе комплексного потенциала переменную типа интерфейса и использовать её для множества конформных отображений,
    /// что определены в программе.
    /// </summary>
